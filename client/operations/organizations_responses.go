...
func (o *OrganizationsOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/organizations][%d] organizationsOK  %+v", 200, o.Payload)
}

func (o *OrganizationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

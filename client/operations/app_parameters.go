...
// NewAppParams creates a new AppParams object
...
// NewAppParamsWithTimeout creates a new AppParams object
// with the default values initialized, and the ability to set a timeout on a request
func NewAppParamsWithTimeout(timeout time.Duration) *AppParams {
	var ()
	return &AppParams{
...
// NewAppParamsWithContext creates a new AppParams object
// with the default values initialized, and the ability to set a context for a request
func NewAppParamsWithContext(ctx context.Context) *AppParams {
	var ()
	return &AppParams{
...
// NewAppParamsWithHTTPClient creates a new AppParams object
// with the default values initialized, and the ability to set a custom HTTPClient for a request
func NewAppParamsWithHTTPClient(client *http.Client) *AppParams {
	var ()
	return &AppParams{
		HTTPClient: client,
	}
...
/*AppParams contains all the parameters to send to the API endpoint
for the app operation typically these are written to a http.Request
*/
...
// WithAppID adds the appID to the app params
func (o *AppParams) WithAppID(appID string) *AppParams {
	o.SetAppID(appID)
	return o
}

// SetAppID adds the appId to the app params

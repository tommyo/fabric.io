...
// DailyNewOKBody daily new o k body
// swagger:model dailyNewOKBody
type DailyNewOKBody struct {
	BasicReport
...
func (m *DailyNewOKBody) UnmarshalJSON(raw []byte) error {
...
func (m DailyNewOKBody) MarshalJSON() ([]byte, error) {
	var _parts [][]byte
...
// Validate validates this daily new o k body
func (m *DailyNewOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DailyNewOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DailyNewOKBody) UnmarshalBinary(b []byte) error {
	var res DailyNewOKBody
